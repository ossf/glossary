...
a. A capability is a feature or function of a system and is a main part of its attack surface.
...
a. Naming capabilities makes it possible to map [threats](threat.md)s and [vulnerability](vulnerability.md)s to specific functions. It supports [risk assessment](risk-assessment.md) and the design of [control](control.md)s that protect or constrain those capabilities.
